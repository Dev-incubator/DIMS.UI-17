...
export function DeleteModal({ handleDelete, handleToggleModal, item }) {
  return (
    <div className={style.wrapper}>
      <h3>Are you sure you want to delete the current {item} ?</h3>
      <div className={style.buttons}>
        <Button title={BUTTONS_NAMES.delete} stylingType={BUTTONS_TYPES.typeDelete} onClick={handleDelete} />
        <Button
